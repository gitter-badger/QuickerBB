...
<style>
	...
	textarea, input {background:#f7f7f7;font-size:1em;font-family:"Times New Roman",Georgia,Arial}
	a:link    {color:#0000FF;} /* unvisited link */
	a:visited {color:#0000FF;} /* visited link */
	a:hover   {color:#FF0000;} /* mouse over link */
	a:active  {color:#FF0000;} /* selected link */
	hr        {border:none;height:1px;background:black}
	div#wrap  {background:#eeeeee;width:880px;margin:auto;padding:2px 5px 3px 5px;
	...
	td.idxa {padding-left:5px;white-space:nowrap}
	td.idxb {padding-left:8px;font-style:italic;width:100%}
	td.idxc {padding-left:16px}
...
<div id="footer">Powered by <a href="http://github.com/halojoy/QuickerBB" target="_blank">QuickerBB</a> &copy; halojoy 2015</div>
</div>
</body>
</html>