...
<style>
	...
	div#wrap  {background:#99ccff;width:880px;margin:auto;padding:2px 5px 3px 5px;
	...
	fieldset#breadcr {background:#ff9999;padding:6px}
	fieldset#contents{background:#eeeeee;padding:0px}
